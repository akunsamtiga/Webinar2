...
const Schedule = () => {
  ...
  const day1Events = [
    ...
    },
    {
      id: 4,
      time: "11:00 - 12:30",
      title: "Workshop: Dasar-dasar Machine Learning",
    ...
    },
    {
      id: 6,
      time: "14:00 - 15:30",
      title: "Case Study: Implementasi AI di Fintech",
    ...
    },
    {
      id: 8,
      time: "16:00 - 17:30",
      title: "Panel Diskusi: Etika AI",
      speaker: "Dr. Anisa Putri dkk.",
      location: "Auditorium A",
      type: "panel"
    }
  ];
              ...
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between">
                ...
                <div className="mt-3 sm:mt-0">
                  <span className={`inline-block px-3 py-1 text-xs font-medium rounded-full ${
                    ...
                    event.type === 'panel' ? 'bg-purple-100 text-purple-800' :
                    event.type === 'opening' ? 'bg-green-100 text-green-800' :
                    event.type === 'closing' ? 'bg-orange-100 text-orange-800' :
                    event.type === 'masterclass' ? 'bg-indigo-100 text-indigo-800' :
                    event.type === 'case-study' ? 'bg-teal-100 text-teal-800' :
                    event.type === 'pitch' ? 'bg-pink-100 text-pink-800' :
